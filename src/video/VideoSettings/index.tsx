...
import { leaveAndUpdateTable } from 'src/tables/actions';
import { selectStorefront } from 'src/storefront/selectors';
import ButtonToolbar from 'react-bootstrap/ButtonToolbar';
import ButtonGroup from 'react-bootstrap/ButtonGroup';
import Button from 'react-bootstrap/Button';
import { RTC } from 'src/agora';
import { getSpeechRecognition } from 'src/speechRecognition';
import { sendAudioTranscript } from 'src/services';
import { useInterval } from 'src/hooks';
import { SEND_TRANSCRIPT_INTERVAL_MS } from 'src/config';
